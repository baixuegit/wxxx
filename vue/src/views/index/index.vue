<template>
  <div class="hello">
    ...
    <div>{{count}}</div>
    <div>
      <el-button type="button" @click="handleState">vuex1</el-button>
    </div>
    <div>{{todo}}</div>
    <div>
      <el-button type="button" @click="handleUserLogin">vuex-action</el-button>
    </div>
    <div>${{price}}</div>
    <div>
      <el-button type="button" @click="handAddShop" >vuex-modules-namespace</el-button>
    </div>
